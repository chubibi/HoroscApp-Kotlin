...
sealed class HoroscopeInfo(val img:Int, val name:Int){
    ...
    object Leo:HoroscopeInfo(R.drawable.tauro, R.string.leo)
    object Virgo:HoroscopeInfo(R.drawable.virgo, R.string.virgo)
    object Libra:HoroscopeInfo(R.drawable.libra, R.string.libra)
    object Scorpio:HoroscopeInfo(R.drawable.escorpion, R.string.scorpio)
    ...
    object Aquarius:HoroscopeInfo(R.drawable.sagitario, R.string.aquarius)
    object Pisces:HoroscopeInfo(R.drawable.sagitario, R.string.pisces)
}